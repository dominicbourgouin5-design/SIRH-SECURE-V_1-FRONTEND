...
window.startEffectivePermissionsPolling = UI.startEffectivePermissionsPolling;
...
window.savePermissionOverrides = HR.savePermissionOverrides;
window.extendPermissionOverride = HR.extendPermissionOverride;
window.convertPermissionOverrideToPermanent = HR.convertPermissionOverrideToPermanent;
window.revokePermissionOverride = HR.revokePermissionOverride;
